...
Damage values are listed in half hearts.

## Equipment and Enchantments
Various changes have been made to equipment and enchantments to improve game balance:
* Gold equipment gets a significant durability increase and has exclusive enchantments geared towards unique use cases. (currently planned)
* Equipment has been rebalanced for consistency.
  * Damage of Copper weapons is now between Stone and Iron weapons.
  * Gold equipment is now identical in strength to Iron equipment except for durability.
  * Some weapon and tool damage has been tweaked slightly.
...
* Some enchantments have been changed:
  ...
  * Projectile Protection has been removed due to it not having a good use case unlike Blast Protection (crystal PvP) and Fire Protection (nether).
  ...
  * Power can now be applied to Crossbows.  Power I increases arrow damage by 1, and each additional level increases damage by 0.5.  Additionally, Power has been nerfed by 1 level for bows (e.g. Power V is now as strong as Power IV in vanilla).
* Equipment created before this plugin is installed on a server will be converted.  They will keep their damage (durability lost), enchantments, and cosmetic modifications.
  * Due to the removal of Projectile Protection, items with this enchantment will have it replaced with Protection.  Items that already have the vanilla Protection enchtantment will have that enchantment replaced with Reinforcement.

Read the full changes [here](https://github.com/YellowStoneTorch/SMP_Expansion/wiki/Equipment-Rebalancing).

## Enchanting and Anvils
Enchanting has been reworked to remove some randomness:
* Enchantments are selected and applied invididually.
...
* At first, most enchantments and their higher levels are locked.  Unlock these by gaining enchantment XP.
  * Enchantment XP is obtained by grindstoning enchantments.
* Books can still be enchanted with random enchantments.  This is a good way to obtain enchantment XP or try your luck.
...
Read more about the new enchanting and anvil mechanics [here](https://github.com/YellowStoneTorch/SMP_Expansion/wiki/Enchanting-and-Anvils).
...
Read more about the new smithing mechanics [here](https://github.com/YellowStoneTorch/SMP_Expansion/wiki/Smithing).
...
Read about the new villager trades [here](https://github.com/YellowStoneTorch/SMP_Expansion/wiki/Villager-Trading).

## SMP Features
These features are useful if you plan to play with friends or strangers.  To access these settings, use the /menu command.  If you as the server owner wish to enable or disable these features, you can configure them in the plugin config.
